...
//main
		...
		printf("				<form action=\"scene1dec_res.cgi\" method=POST>");
		printf("					<textarea id=\"textField1\" cols=30>So do you agree to these terms?</textarea>");
		printf("					<input style:float:right name=\"%s\" type=\"submit\" style=\"width:100px;\" value=\"Yes\">", act);
		printf("					<input style:float:right name=\"%s\" type=\"submit\" style=\"width:100px;\" value=\"No\">", act);
		printf("				</form>");
		printf("				</div>");
		printf("			</div>");
		printf("		</div>");
