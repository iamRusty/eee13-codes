...
//--------------------------------------ALL----------------------------------------
	...
	printf("	</head>");
	printf("	<body onload=\"slender(\'scene10.cgi\')\">");
	//--SCENES---------------------------------------------------------------
//	{	
		...
		printf("  <img src=\"../assets/slender_resize.gif\">");     
		printf("				</div>");
		printf("				<div class=\"main-choices\">");
		printf("					<textarea id=\"textField1\" cols=110>Assume New Line [ENTER] as space [Spacebar]</textarea>");
