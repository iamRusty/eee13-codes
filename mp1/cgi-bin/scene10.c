...
/*
		printf("	<img src=\"../assets/3_doors.png\" height=\"488\" width=\"1060\" usemap\"#door\">");
   printf(" <map name=\"door\" id=\"door\">");
    printf("  <area shape=\"poly\" coords=\"309,376,302,178,395,174,401,372\" href=\"../omgits/level2.htm\" alt=\"click me\">");
    printf("</map>");
*/
		printf("<script type=\"text/javascript\">createSlender(\'%s\')</script>", act);
		printf("  <img src=\"../assets/3_doors.png\" width=\"1060\" height=\"488\" border=\"0\" usemap=\"#door\">");     
   		printf(" <map name=\"door\" id=\"door\">");
  		printf("  <area shape=\"poly\" coords=\"140,35,255,35,255,380,140,380\" href=\"scene10slendintro.cgi\">");
		printf("  <area shape=\"poly\" coords=\"460,35,580,35,580,380,460,380\" href=\"scene11a.cgi\">");
		printf("  <area shape=\"poly\" coords=\"780,35,900,35,900,380,780,380\" href=\"scene10dead.cgi\">");
    	printf("</map>");
		printf("				</div>");
