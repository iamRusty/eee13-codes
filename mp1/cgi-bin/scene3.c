...
//main
		...
		printf("	<img src=\"../assets/cafe_vintage.jpg\" height=\"488\" width=\"1060\" ></img>");
		printf("				</div>");
		printf("				<div class=\"main-choices\">");
		printf("					<textarea id=\"textField1\" cols=110>Dream (flashback)</textarea>");
		printf("					<input type=\"button\" value=\"Next\" onclick=\"display3(%s);\">", act);
		printf("				</div>");
		printf("			</div>");
		printf("		</div>");
//	}
